...
- **Render Engine** Fast rendering of basic shapes, animated graphics text. Enhance the graphics with dynamic light effects.
...
- **Input Support** Receive players interactions via keyboard and mouse.
- **Game Scene** Use scenes to structure your game.
