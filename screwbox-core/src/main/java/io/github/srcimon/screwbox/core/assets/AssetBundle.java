...
public final class AssetBundle {
    ...
    public static final Asset<Pixelfont> FONT_SCREWBOX_WHITE = asset(() -> FONT_SCREWBOX_BLACK.get().replaceColor(Color.BLACK, Color.WHITE));
    ...
    public static final Asset<Pixelfont> FONT_SKINNY_SANS_WHITE = asset(() -> FONT_SKINNY_SANS_BLACK.get().replaceColor(Color.BLACK, Color.WHITE));
