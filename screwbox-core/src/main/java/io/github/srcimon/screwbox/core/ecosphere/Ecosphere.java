...
public interface Ecosphere {

    Ecosphere addEntity(Entity entity);

    Ecosphere addEntities(List<Entity> entities);

    Ecosphere addSystem(EntitySystem system);

    Ecosphere addSystems(EntitySystem... systems);
    ...
    Ecosphere remove(Entity entity);

    Ecosphere remove(List<Entity> entities);
    ...
    Ecosphere toggleSystem(EntitySystem entitySystem);
    ...
    Ecosphere addSystem(Entity... entities);
