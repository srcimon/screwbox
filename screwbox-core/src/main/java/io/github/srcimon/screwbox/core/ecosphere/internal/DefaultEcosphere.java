...
public class DefaultEcosphere implements Ecosphere {

    private final EntityManager entityManager;
    private final SystemManager systemManager;

    public DefaultEcosphere(final Engine engine) {
        this.entityManager = new EntityManager();
        this.systemManager = new SystemManager(engine, entityManager);
    }

    @Override
    public Ecosphere addEntity(final Entity entity) {
    ...
    @Override
    public Ecosphere addSystem(final EntitySystem system) {
    ...
    @Override
    public Ecosphere remove(final Entity entity) {
        entityManager.removeEntity(entity);
        return this;
    }

    @Override
    public Ecosphere remove(final List<Entity> entities) {
    ...
    @Override
    public Ecosphere addSystems(final EntitySystem... systems) {
    ...
    @Override
    public Ecosphere addSystem(final Entity... entities) {
        for (final var entity : entities) {
            addEntity(entity);
        }
        return this;
    ...
    @Override
    public Ecosphere clearEntities() {
    ...
    @Override
    public Ecosphere addEntities(final List<Entity> entities) {
        for (final var entity : entities) {
            addEntity(entity);
        }
        return this;
    ...
    @Override
    public Ecosphere toggleSystem(final EntitySystem entitySystem) {
