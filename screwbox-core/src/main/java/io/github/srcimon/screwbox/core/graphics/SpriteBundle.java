...
public enum SpriteBundle implements AssetBundle<Sprite> {
    ...
    MEN_RED_STAND(animatedAssetFromFile("assets/sprites/MEN_RED_STAND.png", square(16), ofMillis(150))),
    MEN_RED_BURN(animatedAssetFromFile("assets/sprites/MEN_RED_BURN.png", square(16), ofMillis(150))),
    MEN_RED_WALK_BACK(animatedAssetFromFile("assets/sprites/MEN_RED_WALK_BACK.png", square(16), ofMillis(150))),
    MEN_RED_WALK_FRONT(animatedAssetFromFile("assets/sprites/MEN_RED_WALK_FRONT.png", square(16), ofMillis(150))),
    MEN_RED_WALK_LEFT(animatedAssetFromFile("assets/sprites/MEN_RED_WALK_LEFT.png", square(16), ofMillis(150))),
    MEN_RED_WALK_RIGHT(animatedAssetFromFile("assets/sprites/MEN_RED_WALK_RIGHT.png", square(16), ofMillis(150))),
    MEN_YELLOW_STAND(animatedAssetFromFile("assets/sprites/MEN_YELLOW_STAND.png", square(16), ofMillis(150))),
    MEN_YELLOW_BURN(animatedAssetFromFile("assets/sprites/MEN_YELLOW_BURN.png", square(16), ofMillis(150))),
    MEN_YELLOW_WALK_BACK(animatedAssetFromFile("assets/sprites/MEN_YELLOW_WALK_BACK.png", square(16), ofMillis(150))),
    MEN_YELLOW_WALK_FRONT(animatedAssetFromFile("assets/sprites/MEN_YELLOW_WALK_FRONT.png", square(16), ofMillis(150))),
    MEN_YELLOW_WALK_LEFT(animatedAssetFromFile("assets/sprites/MEN_YELLOW_WALK_LEFT.png", square(16), ofMillis(150))),
    MEN_YELLOW_WALK_RIGHT(animatedAssetFromFile("assets/sprites/MEN_YELLOW_WALK_RIGHT.png", square(16), ofMillis(150))),
