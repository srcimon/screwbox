...
public enum SpriteBundle implements AssetBundle<Sprite> {
    ...
    MEN_RED_BURN(animatedAssetFromFile("assets/sprites/MEN_RED_BURN.png", square(16), ofMillis(100))),
    ...
    MEN_YELLOW_BURN(animatedAssetFromFile("assets/sprites/MEN_YELLOW_BURN.png", square(16), ofMillis(100))),
