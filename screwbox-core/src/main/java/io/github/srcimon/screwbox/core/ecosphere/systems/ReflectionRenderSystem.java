...
public class ReflectionRenderSystem implements EntitySystem {
    ...
    public void update(final Engine engine) {
        ...
        final List<Entity> reflectableEntities = engine.ecosphere().fetchAll(RELECTED_ENTITIES);
        for (final Entity reflectionEntity : engine.ecosphere().fetchAll(REFLECTING_AREAS)) {
