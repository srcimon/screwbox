...
import io.github.srcimon.screwbox.core.archivements.internal.LoggingCompletionReaction;
...
class DefaultEngine implements Engine {
    ...
    DefaultEngine(final String name) {
        ...
        archivements = new DefaultArchivements(this,  new LoggingCompletionReaction(log));
