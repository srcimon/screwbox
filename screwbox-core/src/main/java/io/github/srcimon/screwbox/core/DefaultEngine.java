...
import io.github.srcimon.screwbox.core.audio.internal.AudioListener;
...
class DefaultEngine implements Engine {
    ...
    DefaultEngine(final String name) {
        ...
        final AudioListener audioListener = new AudioListener(graphics);
        final DynamicSoundSupport dynamicSoundSupport = new DynamicSoundSupport(audioListener, audioConfiguration);
