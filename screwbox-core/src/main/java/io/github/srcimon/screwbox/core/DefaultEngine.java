...
import io.github.srcimon.screwbox.core.audio.internal.PlaybackSupport;
...
class DefaultEngine implements Engine {
    ...
    DefaultEngine(final String name) {
        ...
        final PlaybackSupport soundOptionsSupport = new PlaybackSupport(audioAdapter, camera, audioConfiguration);
        audio = new DefaultAudio(executor, audioConfiguration, soundOptionsSupport, microphoneMonitor, audioLinePool);
