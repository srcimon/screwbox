...
import io.github.srcimon.screwbox.core.ui.internal.Notifications;
...
class DefaultEngine implements Engine {
    ...
    DefaultEngine(final String name) {
        ...
        final Notifications notifications = new Notifications(screen, this);
        ...
        ui = new DefaultUi(this, scenes, notifications);
