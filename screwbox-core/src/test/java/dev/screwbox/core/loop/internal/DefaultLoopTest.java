...
class DefaultLoopTest {
    ...
    void setTargetFps_targetFpsBelowMinFps_throwsException() {
        assertThatThrownBy(() -> loop.setTargetFps(59))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessage("target fps must be at least 60 (actual value: 59)");
    }
    ...
    void setSpeed_speedTooHeight_throwsException() {
        assertThatThrownBy(() -> loop.setSpeed(11))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessage("speed must be between 0.1 and 10.0 (actual value: 11.0)");
    }
