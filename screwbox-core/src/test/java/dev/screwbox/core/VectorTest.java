...
class VectorTest {
    ...
    @Test
    void limit_lengthBelowMaximum_doesNotChangeVector() {
        assertThat($(3, 9).limit(100)).isEqualTo($(3, 9));
    }

    @Test
    void limit_lengthExceedsMaximum_reducesLength() {
        Vector result = $(200, 50).limit(100);
