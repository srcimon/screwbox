...
class TimeoutSystemTest {
    ...
    @Test
    void update_removesTimedOutComponents(DefaultEcosphere entities, Loop loop) {
    ...
    @Test
    void update_dosntTouchNonTimedOutComponents(DefaultEcosphere entities, Loop loop) {
