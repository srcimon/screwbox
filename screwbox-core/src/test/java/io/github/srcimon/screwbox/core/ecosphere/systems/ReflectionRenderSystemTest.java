...
class ReflectionRenderSystemTest {
    ...
    @Test
    void update_entityInReflectedArea_drawsReflection(DefaultEcosphere entities, Loop loop, World world) {
    ...
    @RepeatedTest(2)
    void update_reflectionAreaNotInWindow_drawsNoSprites(DefaultEcosphere entities, Loop loop,
                                                         World world) {
    ...
    @Test
    void update_waveReflectionEffectUsed_drawsOnDifferenPositions(DefaultEcosphere entities, Loop loop,
                                                                  World world) {
        when(loop.lastUpdate()).thenReturn(Time.atNanos(500000000));
        when(world.visibleArea()).thenReturn($$(0, 0, 1024, 768));
