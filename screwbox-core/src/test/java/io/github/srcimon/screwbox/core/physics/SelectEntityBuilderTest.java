...
class SelectEntityBuilderTest {
    ...
    @BeforeEach
    void beforeEach() {
        selectEntityBuilder = new SelectEntityBuilder(ecosphere, Vector.$(40, 60));
    }
    ...
    void entityBuilderSelectingInBounds_findsOnlyEntitiesInBounds() {
        ...
        when(ecosphere.fetchAll(Archetype.of(TransformComponent.class, ColliderComponent.class)))
                .thenReturn(List.of(first, second, notInBounds));

        SelectEntityBuilder boundsEntityBuilder = new SelectEntityBuilder(ecosphere, $$(0, 0, 100, 100));
    ...
    void selectAny_noEntityAtPosition_returnsEmpty() {
        when(ecosphere.fetchAll(Archetype.of(TransformComponent.class, PhysicsBodyComponent.class)))
                .thenReturn(List.of(
                        boxAt(55, 45),
