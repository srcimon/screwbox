...
class AreaTriggerSystemTest {
    ...
    @Test
    void update_updatesTriggerStatusOfCollidedTriggers(DefaultEcosphere entities) {
    ...
    @Test
    void update_doesntUpdateStatusOfNonCollidedTriggers(DefaultEcosphere entities) {
        Entity deathTrap = new Entity().add(
                new TransformComponent(Bounds.atOrigin(20, 20, 20, 20)),
                new TriggerAreaComponent(Archetype.of(StaticMarkerComponent.class)),
                new SignalComponent());
