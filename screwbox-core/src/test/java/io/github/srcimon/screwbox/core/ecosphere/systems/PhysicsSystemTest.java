...
class PhysicsSystemTest {
    ...
    @Test
    void update_updatesPositionOfPhysicItems(DefaultEcosphere entities, Loop loop) {
    ...
    @Test
    void update_physicBodiesCollideWithEnvironment(DefaultEcosphere entities, Loop loop) {
