...
class StateSystemTest {
    ...
    @Test
    void update_firstStateEnterMethodIsExecuted(DefaultEcosphere entities) {
    ...
    @Test
    void update_nextStateIsNull_throwsException(DefaultEcosphere entities) {
        Entity entity = new Entity().add(
    ...
    @Test
    void update_updatesState(DefaultEcosphere entities) {
        Entity entity = new Entity().add(
                new StateComponent(new PingState()),
                new CounterComponent());
    ...
    @Test
    void update_doesntExecuteStateChangeMethodsWithoutStateChange(DefaultEcosphere entities) {
        Entity entity = new Entity().add(
