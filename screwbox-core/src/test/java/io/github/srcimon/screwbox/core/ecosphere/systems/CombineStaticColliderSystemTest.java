...
class CombineStaticColliderSystemTest {
    ...
    @Test
    void update_combinesHorizontallyAlignedColliders(DefaultEcosphere entities) {
    ...
    @Test
    void update_combinesVerticallyAlignedColliders(DefaultEcosphere entities) {
        Entity brickA = new Entity().add(
                new StaticMarkerComponent(),
                new ColliderComponent(),
                new TransformComponent(Bounds.atOrigin(0, 0, 20, 20)));
    ...
    @Test
    void update_ignoresDifferentColliders(DefaultEcosphere entities) {
        Entity brickA = new Entity().add(
                new StaticMarkerComponent(),
    ...
    @Test
    void update_removesItselfAfterFinishingAllColliders(DefaultEcosphere entities) {
        entities.addSystem(new CombineStaticCollidersSystem());
