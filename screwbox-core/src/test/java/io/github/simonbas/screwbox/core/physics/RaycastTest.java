...
class RaycastTest {
    ...
    void selectAllEnties_rayHitsMultipeEntitiesButSomeAreIgnored_returnsHits() {
        ...
        Assertions.assertThat(result).hasSize(2).contains(foundA, foundB);
    }
    ...
    void findHits_multipleHits_returnsAllHits() {
        ...
        Assertions.assertThat(result).hasSize(6).contains(Vector.of(0, 40));
    }
    @Test
    void nearestHit_multipleHits_returnsNearestHitPosition() {
        ...
        Assertions.assertThat(result).contains(Vector.of(0, 40));
    }
