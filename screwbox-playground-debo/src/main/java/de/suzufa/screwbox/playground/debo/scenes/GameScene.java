...
public class GameScene implements Scene {
    ...
    List<Entity> createEntitiesFromMap() {
        ...
        return EntityExtractor.from(map)
                ...
                .apply(new SlimeConverter())
                .apply(new PlatfomConverter())
                .apply(new WaypointConverter())
                .apply(new CameraConverter())
                .apply(new PlayerConverter())
                .apply(new DeboDConverter())
                .apply(new DeboEConverter())
                .apply(new DeboBConverter())
                .apply(new DeboOConverter())
                .apply(new CherriesConverter())
                .apply(new KillZoneConverter())
                .apply(new BoxConverter())
                .apply(new DiggableConverter())
                .apply(new ChangeMapZoneConverter())
